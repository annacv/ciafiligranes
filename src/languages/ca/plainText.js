export default {
  disclaimer: {
    items: [
      {
        title: 'Informació del titular',
        paragraph:
          "A l'efecte de l'article 10 de la Llei 34/2002, d'11 de juliol, de la Llei de Serveis de la Societat de la Informació i del Comerç Electrònic; s'informa la persona usuària que el titular del web és la Companyia Filigranes, membre de l'Associació Sociocultural de Circ de Terrassa Tub d'Assaig 7'70, amb domicili al carrer St.Leopold núm. 63, Local 5, 08221, Terrassa (Barcelona), amb NIF G-65190431 i correu electrònic ciafiligranes@gmail.com. Els seus membres estan inscrits en el Registre de l'Associació de Professionals de Circ de Catalunya amb els números de socis 0397 i 0237."
      },
      {
        title: "Condicions d'accés i ús",
        paragraph:
      ...
      },
      {
        ...
        paragraph:
          "Les responsables del lloc web es troben adherides al codi de conducta Tipus de l'Associació de Professionals de Circ de Catalunya."
      },
      {
      ...
      {
        paragraph:
          "Independentment de la finalitat per la qual fossin destinats, la reproducció total o parcial, ús, explotació, distribució i comercialització, requereix en tot cas l'autorització escrita prèvia per part de la Companyia Filigranes, en qualitat de responsable del lloc web. Qualsevol ús no autoritzat prèviament per part de la Companyia Filigranes serà considerat un incompliment greu dels drets de propietat intel·lectual i industrial de l'autor."
      },
      {
        paragraph:
      ...
      {
        paragraph:
          "Per fer qualsevol tipus d'observació respecte a possibles incompliments dels drets de propietat intel·lectual o industrial, així com sobre qualsevol dels continguts del lloc web, pots fer-ho a través del següent correu electrònic: ciafiligranes@gmail.com."
      },
      {
        title: 'Continguts',
        paragraph:
          'Aquest lloc web té com a finalitat facilitar el coneixement de les activitats i serveis que realitza la Companyia Filigranes. La Companyia Filigranes es reserva el dret a fer, en qualsevol moment i sense avís previ, modificacions dels continguts i presentació del seu lloc web.'
      },
      {
        title: 'Enllaços',
        paragraph:
      ...
      {
        paragraph:
          "Des del lloc web de la Companyia Filigranes és possible que es redirigeixi a continguts de tercers llocs web. Atès que les responsables del lloc web no poden controlar sempre els continguts introduïts pels tercers en els seus llocs web, aquestes no assumeixen cap tipus de responsabilitat respecte a aquests continguts. En qualsevol cas, les responsables del lloc web manifesten que procediran a la retirada immediata de qualsevol contingut que pogués contravenir la legislació nacional o internacional, la moral o l'ordre públic, procedint a la retirada immediata de la redirecció a aquest lloc web i posant en coneixement de les autoritats competents el contingut en qüestió."
      },
      {
        paragraph:
      ...
      {
        title: 'Privacitat i protecció de dades personals',
        paragraph:
          "Les dades personals que ens puguis facil·litar ja sigui per correu electrònic o per via telefònica únicament les emprarem per a gestionar qualsevol dubte o tràmit relacionat amb la contractació d'espectacles, tallers o animacions amb la Companyia Filigranes. S'ha de tenir en compte que en aquest lloc web no et demanem cap dada personal en cap formulari, sinó que deixem a l'elecció de la usuària el fet d'establir contacte i comunicació amb la Companyia Filigranes mitjançant els canals que es faciliten al lloc web."
      },
      {
        title: 'Cookies',
        paragraph:
      ...
      {
        paragraph: 'Data de la darrera actualització: 26/06/2019.'
      }
    ]
  },
    ...
    items: [
      {
        title: 'Objecte',
        paragraph:
          "La Companyia Filigranes utilitzem cookies per a facilitar la relació de les usuàries amb el nostre contingut i per permetre elaborar estadístiques sobre les visites que rebem. Alhora reconeixem la importància de la normativa i regulació vigent en matèria de privacitat i protecció de dades. La present pàgina descriu la política de cookies que utilitzem a la nostra web. A l'efecte de la present Política de cookies són d'aplicació conjunta les disposicions contingudes en l'Avís legal"
      },
      {
        title: 'Acceptació de la política de cookies',
        paragraph:
          'El fet que una usuària faci servir mitjans tècnics per impedir la descàrrega de cookies al seu navegador no invalida el consentiment prestat a efectes jurídics, encara que el resultat tècnic pot implicar la no descàrrega parcial o total de les mateixes amb els efectes que es descriuen en aquesta política de cookies.'
      },
      {
        title: 'Definició de cookie',
        paragraph:
          "Actualment, tots els lloc web (independentment del servei que presten) utilitzen cookies, és a dir, guarden una informació mínima de la utilització realitzada per l'usuari en el Lloc Web. Per això, una cookie pot definir-se com un petit arxiu de text o dispositiu d'ús generalitzat que es descarrega en l'equip terminal de l'usuari quan navega per les pàgines web amb la finalitat d'emmagatzemar dades que podran ser actualitzades i recuperades per l'entitat responsable de seva instal·lació."
      }
    ]
  }
}
