    ...
    items: [
      {
        title: 'Plis-plas',
        description:
          'Espectáculo de payasos pensado para un público familiar, participativo, con trucos y travesuras constantes.'
      },
      {
    ...
    items: [
      {
        ...
        description:
          'Se adaptan a diferentes temáticas, ideales para amenizar convenciones, encuentros y todo tipo de eventos.'
      },
      {
        title: 'Duración del espectáculo',
