  ...
  plisplas: {
    sheet1: [
      ...
      },
      {
        label: 'Escenografía',
        description:
          'Fondo de escenario redondo y pista semicircular, adaptable a exterior o sala.'
      },
      {
        label: 'Espacio mínimo',
        description: '6m. (ancho) x 8m. (fondo). Superficie plana.'
      },
      {
        label: 'Toma de luz',
    ...
    sheet2: [
      ...
      {
        label: 'Ayudante de Dirección',
        description: 'Montserrat Morera'
      },
      {
        label: 'Dramatúrgia',
        description: 'Carles Grau y Compañía Filigranes'
      },
      {
        label: 'Vestuario',
      ...
      {
        label: 'Arreglos musicales',
        description: 'Marc Monzó'
      },
      {
        label: 'Asesoramiento con malabares',
    ...
    sheet1: [
      {
        ...
        description: 'Público Infantil i/o Familiar.'
      },
      {
        label: 'Espacio',
        description: 'Tanto en un espacio delimitado como en movimiento.'
      },
      {
        label: 'Tiempo de montaje',
      ...
      {
        label: 'Toma de luz y escenografía',
        description: 'A convenir'
      },
      {
        label: 'Equipo de sonido y micros inalámbricos',
        description: 'A convenir'
      }
    ],
    ...
    sheet2: [
      {
        label: 'Actores',
        description:
          'Jordi Torrens y Albert Pérez (posibilidad de un listado más amplio)'
      },
      {
        label: 'Dirección General',
        description: 'Compañía Filigranes'
      ...
      {
        label: 'Escenografía i Vestuario',
        description: 'Compañía Filigranes'
      }
    ]
  }
